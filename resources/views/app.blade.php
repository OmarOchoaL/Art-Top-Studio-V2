...
<head>
    ...
    <!--! BEGIN: Apps Title-->
    <title>Art Top Studio</title>
    <!--! END:  Apps Title-->
    <!--! BEGIN: Favicon-->
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset('assets/images/art_top/logotrans.png') }}">
...
<body>
    ...
    <nav class="nxl-navigation">
        <div class="navbar-wrapper">
            <div class="m-header">
                <a href="{{ route('shop.index') }}" class="b-brand">
                    <!-- ========   change your logo hear   ============ -->
                    <img src="{{ asset('assets/images/art_top/logotrans.png') }}" alt="" class="mx-auto d-block w-75">
                    <img src="{{ asset('assets/images/art_top/avatar.png') }}" alt="" class="logo logo-sm">
                </a>
            </div>
                ...
                <ul class="nxl-navbar">
                    ...
                    <li class="nxl-item nxl-hasmenu">
                        <a href="javascript:void(0);" class="nxl-link">
                            ...
                            <span class="nxl-mtext">Agregar</span><span class="nxl-arrow"><i class="feather-chevron-right"></i></span>
                        </a>
                        <ul class="nxl-submenu">
                            <li class="nxl-item"><a class="nxl-link" href="{{ route('productos.create') }}">Agregar producto</a></li>
                            <li class="nxl-item"> <a class="nxl-link" href="{{ route('categorias.create') }}">Agregar categoría </a> </li>
                            @if(auth()->user()->role == 'admin')
                            <li class="nxl-item">
                                <a class="nxl-link" href="{{ route('usuarios.create') }}">
                                    <span class="nxl-mtext">Agregar Usuario</span>
                                </a>
                            </li>
                            @endif                        
                        </ul>
                    ...
                    <li class="nxl-item nxl-hasmenu">
                        <a href="javascript:void(0);" class="nxl-link">
                            ...
                            <span class="nxl-mtext">Ver</span><span class="nxl-arrow"><i class="feather-chevron-right"></i></span>
                        </a>
                        <ul class="nxl-submenu">
                            <li class="nxl-item"><a class="nxl-link" href="{{ route('productos.index') }}">Ver Productos</a></li>
                            <li class="nxl-item"><a class="nxl-link" href="{{ route('categorias.index') }}">Ver Categorias</a></li>
                            @if(auth()->user()->role == 'admin')
                            <li class="nxl-item">
                                <a class="nxl-link" href="{{ route('usuarios.index') }}">
                                    <span class="nxl-mtext">Ver Usuarios</span>
                                </a>
                            </li>
                            @endif                        
                        </ul>
                    ...
                    <li class="nxl-item nxl-hasmenu">
                        <a href="javascript:void(0);" class="nxl-link">
                            ...
                            <span class="nxl-mtext">Pedidos</span><span class="nxl-arrow"><i class="feather-chevron-right"></i></span>
                        </a>
                        <ul class="nxl-submenu">
                            <li class="nxl-item"><a class="nxl-link" href="{{ route('pedidos.index') }}">Ver Pedidos</a></li>
                            <li class="nxl-item"><a class="nxl-link" href="{{ route('pedidos.create') }}">Crear Pedido</a></li>
                        </ul>
                    </li>
                    
                    <li class="nxl-item mt-4">
                        <form method="POST" action="{{ route('logout') }}">
                            ...
                            <button type="submit" class="nxl-link border-0 bg-transparent w-100 text-start">
                                ...
                                <span class="nxl-mtext">Cerrar sesión</span>
                            </button>
                        </form>
                    </li>
                </ul>
        ...
        <div class="header-wrapper">
            ...
            <div class="header-right ms-auto">
                <div class="d-flex align-items-center">
                    ...
                    <!-- NOTIFICACIONES -->
                    @php
                        $pedidosOnlinePendientes = \App\Models\Order::where('origin', 'online')
                            ->where('status', 'pendiente')
                            ->latest()
                            ->take(5)
                            ->get();

                        $totalPedidosOnlinePendientes = \App\Models\Order::where('origin', 'online')
                            ->where('status', 'pendiente')
                            ->count();
                    @endphp
                    ...
                    <div class="dropdown nxl-h-item">
                        <a class="nxl-head-link me-3" data-bs-toggle="dropdown" href="#" role="button" data-bs-auto-close="outside">
                            ...
                            @if($totalPedidosOnlinePendientes > 0)
                                <span class="badge bg-danger nxl-h-badge">
                                    {{ $totalPedidosOnlinePendientes }}
                                </span>
                            @endif
                        </a>
                        ...
                        <div class="dropdown-menu dropdown-menu-end nxl-h-dropdown nxl-notifications-menu">
                            <div class="d-flex justify-content-between align-items-center notifications-head">
                                <h6 class="fw-bold text-dark mb-0">Notificaciones</h6>
                            </div>

                            @forelse($pedidosOnlinePendientes as $pedido)
                                <div class="notifications-item">
                                    <div class="notifications-desc w-100">
                                        <a href="{{ route('pedidos.index') }}" class="font-body text-truncate-2-line">
                                            <span class="fw-semibold text-dark">
                                                Nuevo pedido online
                                            </span>
                                            Pedido #{{ $pedido->id }} de {{ $pedido->customer_name }}
                                        </a>
                            ...
                            @empty
                                <div class="p-3 text-center text-muted">
                                    No hay pedidos online pendientes.
                                </div>
                            @endforelse

                            <div class="text-center notifications-footer">
                                <a href="{{ route('pedidos.index') }}" class="fs-13 fw-semibold text-dark">
                                    Ver pedidos
                                </a>
                            </div>
                        </div>
    ...
    <div class="theme-customizer">
        <div class="customizer-handle">
            <a href="javascript:void(0);" class="cutomizer-open-trigger" style="background-color:#01746D">
